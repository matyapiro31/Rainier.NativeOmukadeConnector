...
namespace Rainier.NativeOmukadeConnector.Patches
{
    ...
    internal static class WswCommon
    {
        ...
        {
            Delegate dispatcher = (Delegate)wswInstance.GetType().GetField("_dispatcher", BindingFlags.Instance | BindingFlags.NonPublic | BindingFlags.Public).GetValue(wswInstance);
    ...
    public static class HttpRouter_WebsocketEndpoint
    {
        ...
        static bool Prefix(ClientNetworking.IRoute ____route, ref Uri __result)
        {
    ...
    static class Wsw_CreateWebsocket
    {
        static IEnumerable<MethodBase> TargetMethods()
        {
            return Enumerable.Repeat(WswCommon.wswType.GetMethod("CreateWebsocket", BindingFlags.Instance | BindingFlags.NonPublic | BindingFlags.Public), 1);
        }
